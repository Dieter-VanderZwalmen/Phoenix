defmodule HetProjectWeb.Plugs.Locale do
  ...
  def call(conn, _options) do
    case fetch_locale_from(conn) do
      ...
      locale ->
        HetProjectTranslations.Gettext |> Gettext.put_locale(locale)
